  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ 
        ...
        <ul>
          <li>Waitlisted students can only be viewed and managed by the Admin</li>
          <li>Regular and Temporary students are displayed in separate waitlist tables for clarity</li>
         <li>Admins can notify students in order of priority when seats become available</li>
        </ul>
      </div>
    </div>
  );
