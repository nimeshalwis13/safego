  ...
  const generateReportContent = (reportType, data) => {
    switch (reportType) {
      ...
      case 'expired-seats':
        return `
          <div class="summary">
            <h3>Expired Seats Summary</h3>
            <p>Total Expired: ${data.summary.totalExpired}</p>
            <p>Regular Students: ${data.summary.regularExpired}</p>
            <p>Temporary Students: ${data.summary.temporaryExpired}</p>
            <p>Lost Revenue: LKR ${data.summary.lostRevenue.toFixed(2)}</p>
          </div>
          <table>
            <thead>
              <tr>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <h3 style={{ color: "#d32f2f", marginBottom: "15px" }}>⏰ Expired Seats Report</h3>
            <p style={{ color: "#666", marginBottom: "20px" }}>
              Track expired reservations and auto-released seats with lost revenue analysis.
            </p>
            <button
              onClick={() => generatePDFWithDownload('expired-seats', 'Expired & Auto Released Seats Report')}
              disabled={loading}
              style={{
